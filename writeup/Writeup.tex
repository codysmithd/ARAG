...
This algorithm as described was implemented in python, and is open source and viewable on \url{https://github.com/codysmithd/ARAG}. Due to time constraints, many details of the implementation are not ideal, however the algorithm was used successfully to generate many abstracts for evaluation. Once these abstracts were being generated for the given domains, we then took a sample and evaluated them to examine how successful we were.
